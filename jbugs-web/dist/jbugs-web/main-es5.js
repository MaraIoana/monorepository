...
var BugDialogComponent = /** @class */ (function () {
    function BugDialogComponent(userService, formBuilder, dialogRef) {
    ...
    BugDialogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getAllUsers().subscribe(function (data) {
            _this.userList = data;
        });
    };
    BugDialogComponent.prototype.save = function () {
        console.log();
    };
    BugDialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    BugDialogComponent.prototype.submit = function (form) {
        console.log("sadas");
    };
...
var BugsComponent = /** @class */ (function () {
    function BugsComponent(bugService, dialog) {
    ...
    BugsComponent.prototype.agInit = function (params) {
        this.rowData = params.data;
    };
    BugsComponent.prototype.openDialog = function () {
        var _this = this;
        ...
        var dialogRef = this.dialog.open(_status_dialog_status_dialog_component__WEBPACK_IMPORTED_MODULE_5__["StatusDialogComponent"], {
            width: '250px',
            data: status
        });
        dialogRef.afterClosed().subscribe(function (result) {
            console.log('Statusul s-a modificat in !!!!!' + result + " !!!!!!!!!!");
            console.log("bug.status====== " + _this.bugStatus);
            _this.bugStatus.severity = "NULL";
            _this.bugStatus.status = result;
            console.log("bug.status====== " + _this.bugStatus.status);
            _this.bugStatus.id = idBug;
            console.log("bug.id====== " + _this.bugStatus.id);
            _this.bugService.modifyStatus(_this.bugStatus).subscribe();
        });
    };
    BugsComponent.prototype.ngOnInit = function () {
        ...
        this.bugService.getAllBugs()
            ...
            for (var b in _this.bugList) {
                var date = _this.bugList[b].date;
                var d = new Date(date);
                var ds = d.toLocaleString();
                _this.bugList[b].date = ds;
            }
        });
    };
    BugsComponent.prototype.openCreateDialog = function () {
        var dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogConfig"]();
        dialogConfig.disableClose = true;
        dialogConfig.autoFocus = true;
        //this.dialog.open(BugDialogComponent);
        var dialogRef = this.dialog.open(_bug_dialog_bug_dialog_component__WEBPACK_IMPORTED_MODULE_4__["BugDialogComponent"]);
    };
    BugsComponent.prototype.onGridReady = function (params) {
        this.gridApi = params.api;
        this.gridColumnApi = params.columnApi;
    };
    BugsComponent.prototype.onSelectionChanged = function () {
        var selectedRows = this.gridApi.getSelectedRows();
...
var BugEditComponent = /** @class */ (function () {
    function BugEditComponent(dialogRef, data, userService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.userService = userService;
    }
    BugEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rowData = this.data;
        this.userService.getAllUsers().subscribe(function (data) {
            _this.userList = data;
        });
        this.userService.getUserWithId(this.data.assignedTo).subscribe(function (data) {
            _this.username = data.username;
        });
    };
    BugEditComponent.prototype.save = function () {
    ...
    BugEditComponent.prototype.close = function () {
        this.dialogRef.close();
    };
...
var BugsCellComponent = /** @class */ (function () {
    function BugsCellComponent(dialog, bugservice) {
        this.dialog = dialog;
        this.bugservice = bugservice;
    }
    BugsCellComponent.prototype.agInit = function (params) {
        this.rowData = params.data;
        this.gridApi = params.api;
    };
    BugsCellComponent.prototype.ngOnInit = function () {
    };
    BugsCellComponent.prototype.onEdit = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_bug_edit_bug_edit_component__WEBPACK_IMPORTED_MODULE_3__["BugEditComponent"], {
            data: this.rowData
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                ...
                _this.bugservice.updateBug(result.data).subscribe();
            }
        });
    };
    BugsCellComponent.prototype.onDetail = function () {
...
var BugService = /** @class */ (function () {
    ...
    BugService.prototype.modifyStatus = function (b) {
        console.log(b);
...
var StatusDialogComponent = /** @class */ (function () {
    ...
    StatusDialogComponent.prototype.onNoClick = function () {
        this.dialogRef.close(this.statusValue);
    };
    StatusDialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    StatusDialogComponent.prototype.onChange = function (mrChange) {
    ...
    StatusDialogComponent.prototype.ngOnInit = function () {
        this.rowData = this.data;
        this.fixed = true;
        this.info = true;
        this.closed = true;
    ...
    StatusDialogComponent.prototype.visibleRadioButtons = function () {
        if (this.rowData === "NEW") {
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, permissionService, authService) {
        this.router = router;
    ...
    DashboardComponent.prototype.checkPermissions = function () {
    ...
    DashboardComponent.prototype.checkPermissionManagement = function () {
    ...
    DashboardComponent.prototype.checkUserManagement = function () {
    ...
    DashboardComponent.prototype.checkBugManagement = function () {
    ...
    DashboardComponent.prototype.checkBugClose = function () {
    ...
    DashboardComponent.prototype.checkBugExportPDF = function () {
    ...
    DashboardComponent.prototype.checkIsMine = function () {
...
var RoutingErrorComponent = /** @class */ (function () {
    function RoutingErrorComponent(router) {
        this.router = router;
    }
    RoutingErrorComponent.prototype.ngOnInit = function () {
        var _this = this;
...
var LoggedInGuard = /** @class */ (function () {
    function LoggedInGuard(router, permissionService) {
...
var PermissionsDialogComponent = /** @class */ (function () {
    function PermissionsDialogComponent(dialogRef, data, permissionService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.permissionService = permissionService;
    ...
    Object.defineProperty(PermissionsDialogComponent.prototype, "selectedOptions", {
        get: function () {
            return this.permissionsCheck
                .filter(function (opt) { return opt.checked; })
                .map(function (opt) { return opt.type; });
        },
        enumerable: true,
        configurable: true
    });
    PermissionsDialogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.permissionService.getPermissions().subscribe(function (result) {
            _this.permissionList = result;
            for (var _i = 0, result_1 = result; _i < result_1.length; _i++) {
                var r = result_1[_i];
                _this.permissionsCheck.push({
                    type: r.type,
        ...
        this.permissionService.getRolePermissions(this.data.type).subscribe(function (result) {
            _this.rolePermissions = result;
        });
    };
    PermissionsDialogComponent.prototype.onGridReady = function (params) {
        this.gridApi = params.api;
        this.gridColumnApi = params.columnApi;
    };
    PermissionsDialogComponent.prototype.setSelected = function () {
    ...
    PermissionsDialogComponent.prototype.deselectPermissions = function () {
        for (var _i = 0, _a = this.permissionsCheck; _i < _a.length; _i++) {
            var p = _a[_i];
            p.checked = false;
        }
        this.validForm = false;
    };
    PermissionsDialogComponent.prototype.deletePermission = function () {
        var permission = this.gridApi.getSelectedRows()[0];
        if (this.rolePermissions.length > 1) {
            var index = this.rolePermissions.indexOf(permission);
            if (index !== -1) {
    ...
    PermissionsDialogComponent.prototype.savePermission = function () {
        for (var _i = 0, _a = this.selectedOptions; _i < _a.length; _i++) {
            var perm = _a[_i];
            if (this.rolePermissions.map(function (x) { return x.type; }).includes(perm)) {
                console.log(perm + " already exists");
            }
            else {
                var permission = this.getPerm(perm);
                this.rolePermissions.push(permission);
            }
        }
        this.refreshTable();
    };
    PermissionsDialogComponent.prototype.getPerm = function (perm) {
        for (var _i = 0, _a = this.permissionList; _i < _a.length; _i++) {
            var p = _a[_i];
            if (p.type === perm) {
                return p;
            }
    ...
    PermissionsDialogComponent.prototype.validateForm = function () {
    ...
    PermissionsDialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    PermissionsDialogComponent.prototype.save = function () {
        this.dialogRef.close({
            type: this.data.type,
            permissions: this.rolePermissions.map(function (x) { return x.type; })
        });
    };
    PermissionsDialogComponent.prototype.refreshTable = function () {
    ...
    return PermissionsDialogComponent;
}());
...
var RolesCellComponent = /** @class */ (function () {
    function RolesCellComponent(dialog, roleService) {
        this.dialog = dialog;
        this.roleService = roleService;
    }
    RolesCellComponent.prototype.agInit = function (params) {
        this.rowData = params.data;
    };
    RolesCellComponent.prototype.ngOnInit = function () {
    };
    RolesCellComponent.prototype.writeSome = function () {
        console.log("RowData : " + this.rowData.type + " " + this.rowData.permissions);
    };
    RolesCellComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_permissions_dialog_permissions_dialog_component__WEBPACK_IMPORTED_MODULE_3__["PermissionsDialogComponent"], {
            data: this.rowData,
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.roleService.savePermission(result).subscribe(function (data) {
...
var PermissionService = /** @class */ (function () {
    function PermissionService(backendService) {
        this.backendService = backendService;
    ...
    PermissionService.prototype.getUserPermissions = function (username) {
        return this.backendService.post(this.baseUrl + '/permissions/userPermissions', {
            'username': username
        });
    };
    PermissionService.prototype.getRolePermissions = function (type) {
        return this.backendService.post(this.baseUrl + '/permissions/rolePermissions', {
            'type': type
        });
    };
    PermissionService.prototype.decode = function (token) {
        try {
    ...
    PermissionService.prototype.getPermissionsForCurrentUser = function () {
    ...
    PermissionService.prototype.getUsername = function () {
        var token = localStorage.getItem('auth_token');
...
var RoleService = /** @class */ (function () {
    function RoleService(backendService) {
        this.backendService = backendService;
        this.baseUrl = 'http://localhost:8080/jbugs/jbugs-api';
    }
    ...
    RoleService.prototype.getRole = function (roleType) {
        return this.backendService.post(this.baseUrl + '/roles/role', roleType);
    };
    RoleService.prototype.savePermission = function (role) {
        if (role)
...
var AddHeader = /** @class */ (function () {
    function AddHeader(permissionService) {
        this.permissionService = permissionService;
    }
    AddHeader.prototype.intercept = function (request, next) {
...
var UserDetailsComponent = /** @class */ (function () {
    function UserDetailsComponent(dialogRef, data, userService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.userService = userService;
    ...
    UserDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getUserData(this.data.username).subscribe(function (data) {
            console.log(data);
            _this.user = data;
        }, function (error) {
            console.log(error);
    ...
    UserDetailsComponent.prototype.checkButtons = function () {
    ...
    UserDetailsComponent.prototype.activate = function () {
        var _this = this;
        this.userService.activateOrResetUser(this.user.username).subscribe(function (data) {
            console.log(data);
        }, function (error1) { return console.log(error1); }, function () { return _this.dialogRef.close({
            'message': 'ACTIVATED'
        }); });
    };
    UserDetailsComponent.prototype.deactivate = function () {
        var _this = this;
        this.userService.deactivateUser(this.user.username).subscribe(function (data) {
            console.log(data);
        }, function (error1) { return console.log(error1); }, function () { return _this.dialogRef.close({
            'message': 'DEACTIVATED'
        }); });
    };
    UserDetailsComponent.prototype.close = function () {
        this.dialogRef.close();
    };
...
var UsersCellComponent = /** @class */ (function () {
    function UsersCellComponent(router, dialog) {
        this.router = router;
        this.dialog = dialog;
    }
    UsersCellComponent.prototype.agInit = function (params) {
        this.rowData = params.data;
    };
    UsersCellComponent.prototype.ngOnInit = function () {
    };
    UsersCellComponent.prototype.onEdit = function () {
        this.router.navigate(["dashboard/users/edit", this.rowData.username]);
    };
    UsersCellComponent.prototype.onDetail = function () {
        var dialogRef = this.dialog.open(_user_details_user_details_component__WEBPACK_IMPORTED_MODULE_3__["UserDetailsComponent"], {
            data: this.rowData,
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result)
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUserWithId = function (userId) {
        return this.backendService.get(this.baseUrl + '/users/' + userId);
    };
    UserService.prototype.activateOrResetUser = function (username) {
        return this.backendService.put(this.baseUrl + '/users/activate', {
            'username': username
        });
    };
    UserService.prototype.deactivateUser = function (username) {
...
var UserAddComponent = /** @class */ (function () {
    ...
    UserAddComponent.prototype.validateForm = function () {
        if (this.selectedOptions.length !== 0) {
            this.validForm = true;
        }
        else {
...
var UserEditComponent = /** @class */ (function () {
    ...
    UserEditComponent.prototype.isChecked = function () {
        console.log(this.user.roles);
        return true;
    };
    Object.defineProperty(UserEditComponent.prototype, "selectedOptions", {
        get: function () {
            return this.roles
                .filter(function (opt) { return opt.checked; })
                .map(function (opt) { return opt.name; });
    ...
    UserEditComponent.prototype.submit = function (form) {
        ...
        this.userService.updateUser(this.user).subscribe(function (result) { return alert("User with username: " + result.username + " updated successfully"); }, function (error) {
            console.log(error);
        ...
        this.userService.getUser(this.username).subscribe(function (user) {
            ...
            var _loop_1 = function (i) {
                _this.roles.forEach(function (role) {
                    _this.setRole(_this.user.roles[i], role);
                });
            };
            for (var i = 0; i < _this.user.roles.length; i++) {
                _loop_1(i);
            }
        });
        console.log(this.user.roles);
    ...
    UserEditComponent.prototype.setRole = function (role, userRole) {
        if (role == userRole.name) {
            userRole.checked = true;
        }
    };
    UserEditComponent.prototype.validateForm = function () {
        if (this.selectedOptions.length !== 0) {
            this.validForm = true;
        }
        else {
